(custom-set-variables
 ...
 '(emacs-lisp-mode-hook (lambda nil (run-hooks 'prelude-emacs-lisp-mode-hook)))
 ...
 '(org-jekyll-md-include-yaml-front-matter nil)
 '(org-todo-keywords '((sequence "IMPORTANT" "TODO" "UNSUBMITTED" "DONE")))
 '(package-selected-packages
   '(ox-jekyll-md all-the-icons all-the-icons-ibuffer keyfreq all-the-icons-dired org-modern achievements ox-latex-subfigure rjsx-mode chess crossword dashboard-hackernews emoji-display emojify emojify-logos mines dockerfile-mode anaphora deferred polymode ein highlight-escape-sequences highlight-parentheses hl-anything hl-indent hl-sentence websocket zmq jupyter csv-mode anaconda-mode bind-key bui cfrs company-anaconda compat dap-mode hydra lsp-treemacs map org-ql org-super-agenda ov peg pfuture posframe powerline queue request treemacs ts yaml lsp-java lsp-docker ac-capf javadoc-lookup javaimp jtags company-emacs-eclim eclim java-imports java-snippets sudo-edit use-package major-mode-icons ibuffer-sidebar frame-tabs company-org-block ob-typescript org-inline-anim org-inline-pdf org-sidebar org-ac org-bullets avy dash dired-hacks-utils dired-subtree eldoc f gh git-commit highlight-indentation ht js2-refactor json-process-client json-snatcher logito lv magit-section makey markdown-mode marshal multiple-cursors parent-mode pcache pkg-info popup pythonic pyvenv s simple-httpd skewer-mode spinner transient typescript-mode web-completion-data with-editor yasnippet dired-hide-dotfiles dired-icon smartparens tide company company-c-headers dashboard company-web dired-sidebar ac-html ac-html-csswatcher ac-js2 auto-complete django-snippets el-autoyas js-react-redux-yasnippets yasnippet-snippets flymake-eslint indium lua-mode cython-mode flycheck-pycheckers jedi pyenv-mode c-eldoc hl-prog-extra hl-block-mode emoji-fontset solaire-mode highlight-function-calls highlight-operators highlight-numbers yaml-mode web-mode lsp-ui lsp-mode json-mode js2-mode rainbow-mode elisp-slime-nav rainbow-delimiters counsel swiper ivy exec-path-from-shell zop-to-char zenburn-theme which-key volatile-highlights undo-tree super-save smartrep operate-on-number nlinum move-text magit projectile imenu-anywhere hl-todo guru-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region epl editorconfig easy-kill diminish diff-hl discover-my-major crux browse-kill-ring anzu ag ace-window))
 '(prelude-guru nil)
 '(prelude-whitespace nil)
 '(prog-mode-hook '((lambda nil (run-hooks 'prelude-prog-mode-hook))))
...
(custom-set-faces
 ...
 '(web-mode-part-face ((t (:inherit nil))))
